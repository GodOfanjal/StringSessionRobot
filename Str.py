...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [string session](tg://openmessage?user_id=1472531255) \nA Bot By @PegasusUpdates")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/PegasusSupportOfficial'),
                InlineKeyboardButton('Developer', url='https://t.me/cRaZyBoY_420')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/PegasusUpdates'),
            ]
        ]
    )
